...
func NewEnv(state *state.StateDB, chainConfig *params.ChainConfig, chain blockGetter, msg Message, header *types.Header, hash common.Hash, cfg vm.Config) *VMEnv {
	env := &VMEnv{
