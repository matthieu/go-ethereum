...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/matthieu/go-ethereum

    go install github.com/matthieu/go-ethereum/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/matthieu/go-ethereum`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/matthieu/go-ethereum
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/matthieu/go-ethereum/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/matthieu/go-ethereum/wiki/Code-Review-Guidelines).
